...
public class PublishEventMediatorFactory extends AbstractMediatorFactory {
    ...
    public Mediator createSpecificMediator(OMElement omElement, Properties properties) {
        EventPublishMediator mediator = new EventPublishMediator();
    ...
    private void updateBamMediator(BamServerConfigBuilder bamServerConfigBuilder, EventPublishMediator mediator,
        ...
        mediator.getStream().setBamServerConfig(bamServerConfig);
