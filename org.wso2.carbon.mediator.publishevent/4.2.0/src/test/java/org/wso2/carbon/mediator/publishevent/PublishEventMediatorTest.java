...
public class PublishEventMediatorTest extends XMLTestCase {
    ...
    public void _testMediatorFactory() {
        ...
        PublishEventMediator mediator = (PublishEventMediator) factory.createSpecificMediator(mediatorElement, new Properties());
        ...
        assertEquals(mediator.getMetaProperties().get(0).getExpression().toString(), "get-property('axis2', 'HTTP_METHOD')");
        ...
        assertEquals(mediator.getCorrelationProperties().get(0).getExpression().toString(), "get-property('SYSTEM_DATE')");
        ...
        assertEquals(mediator.getPayloadProperties().get(0).getExpression().toString(), "$body/m0:getQuote/m0:request/m0:symbol");
